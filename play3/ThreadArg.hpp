...
{
public:
    ThreadArg5(Master& master_1, Master& master_2):master_enc(master_1), master_dec(master_2)
    {
    ...
    Grad src_grad, tgt_grad;
    Softmax* softmax;
    // VecD target_dist; // size of it is number of target vocabulary size, output, delta
